  ...
  return (
    <div className="mt-24 mb-16 max-w-[1200px] mx-auto relative">
      <div className=" place-items-start px-4 gap-3 grid grid-cols-1 md:grid-cols-2 ">
        ...
        >
          <TypeAnimation
            sequence={["Fullstack Dev", 1000, "EC Engineer", 1000]}
            speed={50}
            repeat={Infinity}
          ...
          <motion.p
            ...
            viewport={{ once: true }} //Animation only works when the page is loaded
            transition={{ duration: 1, delay: 0.5 }} //transition over 1 sec
          ...
          <motion.p
            ...
            className="text-gray-200 text-sm leading-6 md:text-lg  mb-4 max-w-[300px] md:max-w-[600px]"
          >
            An Electronics and Communication Engineering graduate from MACE who
            enjoys building for both the web and IoT. I work with the MERN
            stack, mainly React.js, to create clean, functional web apps, and I
            love exploring how software and hardware can come together to create
            useful solutions.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 50 }} //inital state start with transparent and 50px away from ins final position
          ...
          >
            ...
            <div className=" flex gap-6 flex-row text-4xl md:text-6xl text-purple-400 z-20">
              <motion.a
                ...
                href="https://github.com/Afthar17"
                rel="noreferrer"
                target="_blank"
              >
                <AiOutlineGithub />
              ...
              <motion.a
                whileHover={{ scale: 1.2 }}
                href="https://www.linkedin.com/in/afthar-n-n-665a29314/"
              ...
              <motion.a
                whileHover={{ scale: 1.2 }}
                href="https://www.instagram.com/_a_f_t_h_a_r_17/?hl=en"
                rel="noreferrer"
                target="_blank"
              >
                <AiOutlineInstagram />
        ...
        <div className="relative">
          <motion.img
            src={me}
            className="z-10  mb-2"
            initial={{ opacity: 0, scale: 0.6 }} //inital state start with transparent
            whileInView={{ opacity: 1, scale: 1, delay: 0.5, duration: 1 }} // it becomes viewable
            viewport={{ once: true }} //Animation only works when the page is loaded
            transition={{ smoooth: true, duration: 1, delay: 0.5 }} //transition over 1 sec
          />
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0, delay: 0.5, duration: 1 }}
        viewport={{ once: true }}
          ...
          <div className="animate-scroll flex gap-8 items-center whitespace-nowrap">
            {[...Array(3)].map((_, i) => (
              ...
              >
                ...
                <SiNextdotjs className="text-gray-300 text-4xl md:text-6xl" />
                ...
                <img
                  src={zustand}
                  className="text-gray-600 w-10 h-10 md:w-14 md:h-14 "
                />
